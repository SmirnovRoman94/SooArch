               ...
               <form>
                   ...
                   <div class="example" v-for="item in work.example" :key="item.id">
                       ...
                       <div class="controls_example">
                           <button class="controls_example_item" @click.prevent="deletePoint(item)">Удалить пункт</button>
                   ...
                   <div class="controls">
                       <button class="controls_item" @click.prevent="addWork">Добавить работу</button>
